...
export function Navbar({ showSearch = true, onSearchChange, searchValue = "" }: NavbarProps) {
  ...
  /** True once user has scrolled past the hero top */
  ...
  const navStyle: React.CSSProperties = {
    background: isScrolled ? "rgba(41, 50, 65, 0.82)" : "#293241",
    backdropFilter: isScrolled ? "blur(14px) saturate(1.4)" : "none",
    WebkitBackdropFilter: isScrolled ? "blur(14px) saturate(1.4)" : "none",
    borderColor: "rgba(255,255,255,0.08)",
    transition: "background 0.35s ease, backdrop-filter 0.35s ease",
  };

  return (
    <nav className="border-b sticky top-0 z-50 min-w-full" style={navStyle}>
            ...
            <div className="flex-1 max-w-md hidden md:block">
              <div className="relative">
                ...
                <input
                  ...
                  onFocus={(e) => {
                    (e.target as HTMLInputElement).style.background = "rgba(255,255,255,0.14)";
                    (e.target as HTMLInputElement).style.borderColor = "rgba(152,193,217,0.4)";
                  }}
                  onBlur={(e) => {
                    (e.target as HTMLInputElement).style.background = "rgba(255,255,255,0.09)";
                    (e.target as HTMLInputElement).style.borderColor = "rgba(255,255,255,0.13)";
                  }}
                />
              </div>
            </div>
            ...
            {usuario ? (
              <>
                ...
                <div className="flex items-center gap-2 ml-2">
                  ...
                  <span className="hidden lg:block" style={{ color: "#E0FBFC", fontFamily: "'Lato', sans-serif" }}>
